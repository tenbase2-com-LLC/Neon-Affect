 ...
 * 
 */
public plan OfferingEncouragementSupportCooperativePlan extends Plan {

    #handles event Level2PosAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level2PosAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.COOPERATIVE;
    }
