...
public class OverthinkingSocialSituationsLonelyPlan extends aos.jack.jak.plan.Plan {
    ...
    public NeonAffect.Level2NegAffectEvent ev1;
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/OverthinkingSocialSituationsLonelyPlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    private final static java.lang.String[] __fsmLocalNames_body = {
            "__local__1974_0"};
    static boolean relevant(NeonAffect.Level2NegAffectEvent ev1)
    {
        return ev1.iAffect == NeonAffect.AffectEnum.LONELY;
    }
    ...
    public OverthinkingSocialSituationsLonelyPlan()
    {
    }
    
    private OverthinkingSocialSituationsLonelyPlan(aos.jack.jak.task.Task __t, NeonAffect.OverthinkingSocialSituationsLonelyPlan __env)
    {
    ...
    {
        ev1 = (NeonAffect.Level2NegAffectEvent) __a.findEvent("NeonAffect.Level2NegAffectEvent");
        if (ev1 == null) {
            warning("Level2NegAffectEvent ev1: is not found in the capability/agent this plan comes from");
            return false;
        }
    ...
    {
        return new NeonAffect.OverthinkingSocialSituationsLonelyPlan.__bodyFSM();
    }
    
    private OverthinkingSocialSituationsLonelyPlan(NeonAffect.Level2NegAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.OverthinkingSocialSituationsLonelyPlan __env)
    {
        this(__t,__env);
        this.ev1 = __ev;
    }
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new NeonAffect.OverthinkingSocialSituationsLonelyPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__1974_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-OverthinkingSocialSituationsLonelyPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.OverthinkingSocialSituationsLonelyPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("OverthinkingSocialSituationsLonelyPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__1974_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 4;
                            __state = 13;
                            __local__1974_0.printStackTrace();
                            break;
                        }
                        //* (49)             mutex.signal();
                        case 13: 
        ...
        {
            return NeonAffect.OverthinkingSocialSituationsLonelyPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.OverthinkingSocialSituationsLonelyPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__1974_0);
                }
                default: 
                {
