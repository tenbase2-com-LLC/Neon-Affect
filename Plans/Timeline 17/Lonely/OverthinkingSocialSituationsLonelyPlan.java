 ...
 * 
 */
public plan OverthinkingSocialSituationsLonelyPlan extends Plan {

    #handles event Level2NegAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level2NegAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.LONELY;
    }
