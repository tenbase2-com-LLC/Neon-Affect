 ...
 * 
 */
public plan PositiveAttributionEnhancementPlan extends Plan {

    #handles event Level6PosAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level6PosAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.TRIUMPHANT;
    }
