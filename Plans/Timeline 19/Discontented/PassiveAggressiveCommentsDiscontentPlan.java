 ...
 * 
 */
public plan PassiveAggressiveCommentsDiscontentPlan extends Plan {

    #handles event Level3NegAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level3NegAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.DISCONTENTED;
    }
