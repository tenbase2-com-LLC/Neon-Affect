...
public class AbnoxiousImpatiencePlan extends aos.jack.jak.plan.Plan {
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/AbnoxiousImpatiencePlan.plan",
            "body",
            "41",
            "42",
            "44",
    ...
    public AbnoxiousImpatiencePlan()
    {
    }
    
    private AbnoxiousImpatiencePlan(aos.jack.jak.task.Task __t, NeonAffect.AbnoxiousImpatiencePlan __env)
    {
    ...
    {
        return new NeonAffect.AbnoxiousImpatiencePlan.__bodyFSM();
    }
    
    private AbnoxiousImpatiencePlan(NeonAffect.Level4NegAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.AbnoxiousImpatiencePlan __env)
    {
        this(__t,__env);
        this.ev8 = __ev;
    }
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new NeonAffect.AbnoxiousImpatiencePlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__1_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-AbnoxiousImpatiencePlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.AbnoxiousImpatiencePlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("AbnoxiousImpatiencePlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 2;
                            __state = 13;
                            __local__1_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
        ...
        {
            return NeonAffect.AbnoxiousImpatiencePlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.AbnoxiousImpatiencePlan.body");
        }
