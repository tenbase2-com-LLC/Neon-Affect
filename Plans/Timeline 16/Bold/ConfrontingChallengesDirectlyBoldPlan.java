...
public class ConfrontingChallengesDirectlyBoldPlan extends aos.jack.jak.plan.Plan {
    ...
    public NeonAffect.Level4PosAffectEvent ev1;
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/ConfrontingChallengesDirectlyBoldPlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    private final static java.lang.String[] __fsmLocalNames_body = {
            "__local__517_0"};
    static boolean relevant(NeonAffect.Level4PosAffectEvent ev1)
    {
        return ev1.iAffect == NeonAffect.AffectEnum.BOLD;
    }
    ...
    public ConfrontingChallengesDirectlyBoldPlan()
    {
    }
    
    private ConfrontingChallengesDirectlyBoldPlan(aos.jack.jak.task.Task __t, NeonAffect.ConfrontingChallengesDirectlyBoldPlan __env)
    {
    ...
    {
        ev1 = (NeonAffect.Level4PosAffectEvent) __a.findEvent("NeonAffect.Level4PosAffectEvent");
        if (ev1 == null) {
            warning("Level4PosAffectEvent ev1: is not found in the capability/agent this plan comes from");
            return false;
        }
    ...
    {
        return new NeonAffect.ConfrontingChallengesDirectlyBoldPlan.__bodyFSM();
    }
    
    private ConfrontingChallengesDirectlyBoldPlan(NeonAffect.Level4PosAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.ConfrontingChallengesDirectlyBoldPlan __env)
    {
        this(__t,__env);
        this.ev1 = __ev;
    }
    ...
    {
        return "NeonAffect.Level4PosAffectEvent";
    }
    
    public boolean __relevant(aos.jack.jak.event.Event __e)
    {
        return __ns.isEnabled() && relevant(((NeonAffect.Level4PosAffectEvent) __e));
    }
    
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        if (!(__e instanceof NeonAffect.Level4PosAffectEvent)) 
            return null;
        NeonAffect.Level4PosAffectEvent __e1 = (NeonAffect.Level4PosAffectEvent) __e;
        return new NeonAffect.ConfrontingChallengesDirectlyBoldPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__517_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-ConfrontingChallengesDirectlyBoldPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.ConfrontingChallengesDirectlyBoldPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("ConfrontingChallengesDirectlyBoldPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__517_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 4;
                            __state = 13;
                            __local__517_0.printStackTrace();
                            break;
                        }
                        //* (49)             mutex.signal();
                        case 13: 
        ...
        {
            return NeonAffect.ConfrontingChallengesDirectlyBoldPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.ConfrontingChallengesDirectlyBoldPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__517_0);
                }
                default: 
                {
