...
public class AcknowledgingMistakesResponsiblePlan extends aos.jack.jak.plan.Plan {
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/AcknowledgingMistakesResponsiblePlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    public AcknowledgingMistakesResponsiblePlan()
    {
    }
    
    private AcknowledgingMistakesResponsiblePlan(aos.jack.jak.task.Task __t, NeonAffect.AcknowledgingMistakesResponsiblePlan __env)
    {
    ...
    {
        return new NeonAffect.AcknowledgingMistakesResponsiblePlan.__bodyFSM();
    }
    
    private AcknowledgingMistakesResponsiblePlan(NeonAffect.Level2PosAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.AcknowledgingMistakesResponsiblePlan __env)
    {
        this(__t,__env);
        this.ev1 = __ev;
    }
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new NeonAffect.AcknowledgingMistakesResponsiblePlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__10_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-AcknowledgingMistakesResponsiblePlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.AcknowledgingMistakesResponsiblePlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("AcknowledgingMistakesResponsiblePlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__10_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
        ...
        {
            return NeonAffect.AcknowledgingMistakesResponsiblePlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.AcknowledgingMistakesResponsiblePlan.body");
        }
