 ...
 * 
 */
public plan SharingWhimsicalThoughtsCarefreePlan extends Plan {

    #handles event Level3PosAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level3PosAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.CAREFREE;
    }
