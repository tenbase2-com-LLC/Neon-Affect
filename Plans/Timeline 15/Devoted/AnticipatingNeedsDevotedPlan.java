...
public class AnticipatingNeedsDevotedPlan extends aos.jack.jak.plan.Plan {
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/AnticipatingNeedsDevotedPlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    public AnticipatingNeedsDevotedPlan()
    {
    }
    
    private AnticipatingNeedsDevotedPlan(aos.jack.jak.task.Task __t, NeonAffect.AnticipatingNeedsDevotedPlan __env)
    {
    ...
    {
        return new NeonAffect.AnticipatingNeedsDevotedPlan.__bodyFSM();
    }
    
    private AnticipatingNeedsDevotedPlan(NeonAffect.Level4PosAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.AnticipatingNeedsDevotedPlan __env)
    {
        this(__t,__env);
        this.ev1 = __ev;
    }
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new NeonAffect.AnticipatingNeedsDevotedPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__62_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-AnticipatingNeedsDevotedPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.AnticipatingNeedsDevotedPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("AnticipatingNeedsDevotedPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__62_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
        ...
        {
            return NeonAffect.AnticipatingNeedsDevotedPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.AnticipatingNeedsDevotedPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__62_0);
                }
                default: 
                {
