 ...
 * 
 */
public plan IncreasingNegativeLevelPlan extends Plan {
    ...
    #uses data CancelPlan cancelINLPlan;
    ...
    setIncreasingNegativeCursors()
    {
        ...
        if (bDebug)
        { 
            System.out.println("Inside IncreasingNegativeLevelPlan.");
        }
        ...
        @parallel(ParallelFSM.FIRST, cancelINLPlan.getValue(), new Exception("Increasing Negative Parallel exception"), null)
        {               
            try
            {
                while (true)
        ...
        if (bDebug)
        {
            System.out.println("After IncreasingNegativeLevelPlan wait_for.");
        }
