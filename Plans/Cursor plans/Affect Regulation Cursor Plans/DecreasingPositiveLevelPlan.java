 ...
 * 
 */
public plan DecreasingPositiveLevelPlan extends Plan {
    ...
    #uses data CancelPlan cancelDPLPlan;
    ...
    {   
        ...
        if (bDebug)
        { 
            System.out.println("Inside DecreasingPositiveLevelPlan.");
        }
        ...
        @parallel(ParallelFSM.FIRST, cancelDPLPlan.getValue(), new Exception("Increasing Negative Parallel exception"), null)
        {               
            try
            {
                while (true)
        ...
        if (bDebug)
        {
            System.out.println("After DecreasingPositiveLevelPlan wait_for.");
        }
