 ...
 * 
 */
public plan Level6PosAffectPlan extends Plan {
    ...
    {        
        ...
        {   
            ...
            if (bDebug)
            { 
                System.out.println("Inside Level6PosAffectPlan.");
            }
        
            Level6PosAffect c = new Level6PosAffect(enc.emotionCursorVar, enc.GetAgent());
            ...
            {                
                ...
                */
                ...
                if (bDebug)
                {
                    System.out.println("Level6PosAffectPlan: after wait_for.");
                }
                
                @post(lce.post(CursorEnum.iLEVEL_CURSOR_POS_6));
                @wait_for(mutex6.planWait());
            }
    
            if (bDebug)
            {
                System.out.println("After Level6PosAffectPlan wait_for.");
            }
        }
        catch (Exception e)
        {
