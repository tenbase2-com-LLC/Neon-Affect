 ...
 * 
 */
public plan Level3PosAffectPlan extends Plan {
    ...
    {    
        ...
        {   logical int $affect;
            ...
            if (bDebug)
            { 
                System.out.println("Inside Level3PosAffectPlan.");
            }
        
            Level3PosAffect c = new Level3PosAffect(enc.emotionCursorVar, enc.GetAgent());
            ...
            while (true)
            {
                ...
                */
                ...
                if (bDebug)
                {
                    System.out.println("Level3PosAffectPlan: after wait_for.");
                }
                
                @post(lce.post(CursorEnum.iLEVEL_CURSOR_POS_3));   
                @wait_for(mutex6.planWait());
            }
        
            if (bDebug)
            {
                System.out.println("After Level3PosAffectPlan wait_for.");
            }
        }
        catch (Exception e)
        {
