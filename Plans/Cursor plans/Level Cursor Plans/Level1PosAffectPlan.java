...
public plan Level1PosAffectPlan extends Plan {
    ...
    {       
        ...
        {     
            ...
            if (bDebug)
            { 
                System.out.println("Inside Level1PosAffectPlan.");
            }
            ...
            while(true)
            {
                ...
                */
                ...
                if (bDebug)
                {
                    System.out.println("Level1PosAffectPlan: after wait_for.");
                }
                
                @post(lce.post(CursorEnum.iLEVEL_CURSOR_POS_1));                
                @wait_for(mutex6.planWait());
            }
            
            if (bDebug)
            {    
                System.out.println("After Level1PosAffectPlan wait_for.");            
            }
        }
        catch (Exception e)
        {
