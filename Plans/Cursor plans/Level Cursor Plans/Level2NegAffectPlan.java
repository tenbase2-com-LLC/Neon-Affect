 ...
 * 
 */
public plan Level2NegAffectPlan extends Plan {

    #handles event SetAffectCursorsEvent ev1;
    #posts event Level2NegAffectEvent ev7;
    ...
    {   
        ...
        {   
            ...
            if (bDebug)
            {                 
                System.out.println("Inside Level2NegAffectPlan.");
            }
        
            Level2NegAffect c = new Level2NegAffect(enc.emotionCursorVar, enc.GetAgent());
            ...
            while(true)
            {
                ...
                */
                ...
                if (bDebug)
                {
                    System.out.println("Level2NegAffectPlan: after wait_for.");
                }
                
                @post(lce.post(CursorEnum.iLEVEL_CURSOR_NEG_2)); 
                @wait_for(mutex6.planWait());
           }
            
            if (bDebug)
            {    
                System.out.println("After Level2NegAffectPlan wait_for.");
            }
        }
        catch (Exception e)
        {
