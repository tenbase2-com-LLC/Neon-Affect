...
public class BlinkingRapidlySurprisedPlan extends aos.jack.jak.plan.Plan {
    ...
    public NeonAffect.Level5PosAffectEvent ev8;
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/BlinkingRapidlySurprisedPlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    private final static java.lang.String[] __fsmLocalNames_body = {
            "__local__337_0"};
    static boolean relevant(NeonAffect.Level5PosAffectEvent ev8)
    {
        return ev8.iAffect == NeonAffect.AffectEnum.SURPRISED;
    }
    ...
    public BlinkingRapidlySurprisedPlan()
    {
    }
    
    private BlinkingRapidlySurprisedPlan(aos.jack.jak.task.Task __t, NeonAffect.BlinkingRapidlySurprisedPlan __env)
    {
    ...
    {
        ev8 = (NeonAffect.Level5PosAffectEvent) __a.findEvent("NeonAffect.Level5PosAffectEvent");
        if (ev8 == null) {
            warning("Level5PosAffectEvent ev8: is not found in the capability/agent this plan comes from");
            return false;
        }
    ...
    {
        return new NeonAffect.BlinkingRapidlySurprisedPlan.__bodyFSM();
    }
    
    private BlinkingRapidlySurprisedPlan(NeonAffect.Level5PosAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.BlinkingRapidlySurprisedPlan __env)
    {
        this(__t,__env);
        this.ev8 = __ev;
    }
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new NeonAffect.BlinkingRapidlySurprisedPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__337_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-BlinkingRapidlySurprisedPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.BlinkingRapidlySurprisedPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("BlinkingRapidlySurprisedPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__337_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 4;
                            __state = 13;
                            __local__337_0.printStackTrace();
                            break;
                        }
                        //* (49)             mutex.signal();    
                        case 13: 
        ...
        {
            return NeonAffect.BlinkingRapidlySurprisedPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.BlinkingRapidlySurprisedPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__337_0);
                }
                default: 
                {
