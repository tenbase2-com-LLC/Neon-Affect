 ...
 * 
 */
public plan BlinkingRapidlySurprisedPlan extends Plan {

    #handles event Level5PosAffectEvent ev8;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level5PosAffectEvent ev8)
    {
        return ev8.iAffect == AffectEnum.SURPRISED;
    }
