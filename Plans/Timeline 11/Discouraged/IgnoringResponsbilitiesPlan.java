 ...
 * 
 */
public plan IgnoringResponsbilitiesPlan extends Plan {

    #handles event Level5NegAffectEvent ev5;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level5NegAffectEvent ev5)
    {
        return ev5.iAffect == AffectEnum.DISCOURAGED;
    }
