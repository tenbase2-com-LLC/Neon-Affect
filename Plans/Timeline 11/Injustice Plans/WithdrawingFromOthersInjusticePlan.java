 ...
 * 
 */
public plan WithdrawingFromOthersInjusticePlan extends Plan {

    #handles event Level4NegAffectEvent ev4;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level4NegAffectEvent ev4)
    {
        return ev4.iAffect == AffectEnum.INJUSTICE;
    }
