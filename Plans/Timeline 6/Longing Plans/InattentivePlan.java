...
/**
 * not concentrating on the environment
 */
public plan InattentivePlan extends Plan {

    #handles event Level3PosAffectEvent ev2;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level3PosAffectEvent ev2)
    {
        return ev2.iAffect == AffectEnum.LONGING;
    }
