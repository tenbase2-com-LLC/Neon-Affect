...
/**
 * stating facts "remember when..."
 */
public plan FearmongeringDoubtPlan extends Plan {

    #handles event Level2NegAffectEvent ev7;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level2NegAffectEvent ev7)
    {
        return ev7.iAffect == AffectEnum.DOUBT;
    }
