...
public class MakeSenseSituationThoughtsRacingPlan extends aos.jack.jak.plan.Plan {
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/MakeSenseSituationThoughtsRacingPlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    private final static java.lang.String[] __fsmLocalNames_body = {
            "__local__1686_0"};
    static boolean relevant(NeonAffect.Level2NegAffectEvent ev7)
    {
        return ev7.iAffect == NeonAffect.AffectEnum.WARINESS;
    }
    ...
    public MakeSenseSituationThoughtsRacingPlan()
    {
    }
    
    private MakeSenseSituationThoughtsRacingPlan(aos.jack.jak.task.Task __t, NeonAffect.MakeSenseSituationThoughtsRacingPlan __env)
    {
    ...
    {
        return new NeonAffect.MakeSenseSituationThoughtsRacingPlan.__bodyFSM();
    }
    
    private MakeSenseSituationThoughtsRacingPlan(NeonAffect.Level2NegAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.MakeSenseSituationThoughtsRacingPlan __env)
    {
        this(__t,__env);
        this.ev7 = __ev;
    }
    ...
    {
        return ev7.getSignature(__log);
    }
    
    public java.lang.String handledEvent()
    {
        return "NeonAffect.Level2NegAffectEvent";
    }
    
    public boolean __relevant(aos.jack.jak.event.Event __e)
    {
        return __ns.isEnabled() && relevant(((NeonAffect.Level2NegAffectEvent) __e));
    }
    
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        if (!(__e instanceof NeonAffect.Level2NegAffectEvent)) 
            return null;
        NeonAffect.Level2NegAffectEvent __e1 = (NeonAffect.Level2NegAffectEvent) __e;
        return new NeonAffect.MakeSenseSituationThoughtsRacingPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__1686_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-MakeSenseSituationThoughtsRacingPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.MakeSenseSituationThoughtsRacingPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("MakeSenseSituationThoughtsRacingPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__1686_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 4;
                            __state = 13;
                            __local__1686_0.printStackTrace();
                            break;
                        }
                        //* (49)             mutex.signal();    
                        case 13: 
        ...
        {
            return NeonAffect.MakeSenseSituationThoughtsRacingPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.MakeSenseSituationThoughtsRacingPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__1686_0);
                }
                default: 
                {
