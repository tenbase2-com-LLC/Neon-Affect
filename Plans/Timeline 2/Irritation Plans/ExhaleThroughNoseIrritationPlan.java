...
public class ExhaleThroughNoseIrritationPlan extends aos.jack.jak.plan.Plan {
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/ExhaleThroughNoseIrritationPlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    {
        return ev12.iAffect == NeonAffect.AffectEnum.IRRITATION;
    }
    ...
    public ExhaleThroughNoseIrritationPlan()
    {
    }
    
    private ExhaleThroughNoseIrritationPlan(aos.jack.jak.task.Task __t, NeonAffect.ExhaleThroughNoseIrritationPlan __env)
    {
    ...
    {
        ev12 = (NeonAffect.Level1NegAffectEvent) __a.findEvent("NeonAffect.Level1NegAffectEvent");
        if (ev12 == null) {
            warning("Level1NegAffectEvent ev12: is not found in the capability/agent this plan comes from");
            return false;
        }
    ...
    {
        return new NeonAffect.ExhaleThroughNoseIrritationPlan.__bodyFSM();
    }
    
    private ExhaleThroughNoseIrritationPlan(NeonAffect.Level1NegAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.ExhaleThroughNoseIrritationPlan __env)
    {
        this(__t,__env);
        this.ev12 = __ev;
    }
    ...
    {
        return ev12.getSignature(__log);
    }
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new NeonAffect.ExhaleThroughNoseIrritationPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__851_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-ExhaleThroughNoseIrritationPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.ExhaleThroughNoseIrritationPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("ExhaleThroughNoseIrritationPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__851_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 4;
                            __state = 13;
                            __local__851_0.printStackTrace();
                            break;
                        }
                        //* (49)             mutex.signal();    
                        case 13: 
        ...
        {
            return NeonAffect.ExhaleThroughNoseIrritationPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.ExhaleThroughNoseIrritationPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__851_0);
                }
                default: 
                {
