...
public class DisconnectWithLifeIndifferencePlan extends aos.jack.jak.plan.Plan {
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/DisconnectWithLifeIndifferencePlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    private final static java.lang.String[] __fsmLocalNames_body = {
            "__local__714_0"};
    static boolean relevant(NeonAffect.Level1PosAffectEvent ev11)
    {
        return ev11.iAffect == NeonAffect.AffectEnum.INDIFFERENCE;
    }
    ...
    public DisconnectWithLifeIndifferencePlan()
    {
    }
    
    private DisconnectWithLifeIndifferencePlan(aos.jack.jak.task.Task __t, NeonAffect.DisconnectWithLifeIndifferencePlan __env)
    {
    ...
    {
        return new NeonAffect.DisconnectWithLifeIndifferencePlan.__bodyFSM();
    }
    
    private DisconnectWithLifeIndifferencePlan(NeonAffect.Level1PosAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.DisconnectWithLifeIndifferencePlan __env)
    {
        this(__t,__env);
        this.ev11 = __ev;
    }
    ...
    {
        return ev11.getSignature(__log);
    }
    
    public java.lang.String handledEvent()
    {
        return "NeonAffect.Level1PosAffectEvent";
    }
    
    public boolean __relevant(aos.jack.jak.event.Event __e)
    {
        return __ns.isEnabled() && relevant(((NeonAffect.Level1PosAffectEvent) __e));
    }
    
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        if (!(__e instanceof NeonAffect.Level1PosAffectEvent)) 
            return null;
        NeonAffect.Level1PosAffectEvent __e1 = (NeonAffect.Level1PosAffectEvent) __e;
        return new NeonAffect.DisconnectWithLifeIndifferencePlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__714_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-DisconnectWithLifeIndifferencePlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.DisconnectWithLifeIndifferencePlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("DisconnectWithLifeIndifferencePlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__714_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 4;
                            __state = 13;
                            __local__714_0.printStackTrace();
                            break;
                        }
                        //* (49)             mutex.signal();    
                        case 13: 
        ...
        {
            return NeonAffect.DisconnectWithLifeIndifferencePlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.DisconnectWithLifeIndifferencePlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__714_0);
                }
                default: 
                {
