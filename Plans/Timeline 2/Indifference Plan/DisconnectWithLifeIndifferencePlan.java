 ...
 * 
 */
public plan DisconnectWithLifeIndifferencePlan extends Plan {

    #handles event Level1PosAffectEvent ev11;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level1PosAffectEvent ev11)
    {
        return ev11.iAffect == AffectEnum.INDIFFERENCE;
    }
