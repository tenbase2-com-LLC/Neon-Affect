...
/**
 * blaming another, arguing, changing the focus to something else
 */
public plan DeflectingPlan extends Plan {

    #handles event Level3NegAffectEvent ev8;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level3NegAffectEvent ev8)
    {
        return ev8.iAffect == AffectEnum.FLUSTERED;
    }
