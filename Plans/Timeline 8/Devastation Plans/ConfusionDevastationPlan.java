...
/**
 * not focusing on anything (looking)
 */
public plan ConfusionDevastationPlan extends Plan {

    #handles event Level5NegAffectEvent ev13;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level5NegAffectEvent ev13)
    {
        return ev13.iAffect == AffectEnum.DEVASTATION;
    }
