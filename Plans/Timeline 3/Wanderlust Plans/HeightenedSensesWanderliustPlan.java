 ...
 * 
 */
public plan HeightenedSensesWanderliustPlan extends Plan {

    #handles event Level6PosAffectEvent ev5;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level6PosAffectEvent ev5)
    {
        return ev5.iAffect == AffectEnum.WANDERLUST;
    }
