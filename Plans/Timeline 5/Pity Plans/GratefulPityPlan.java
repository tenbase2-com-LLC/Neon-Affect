...
/**
 *  glad not in same situation
 */
public plan GratefulPityPlan extends Plan {

    #handles event Level4NegAffectEvent ev8;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level4NegAffectEvent ev8)
    {
        return ev8.iAffect == AffectEnum.PITY;
    }
