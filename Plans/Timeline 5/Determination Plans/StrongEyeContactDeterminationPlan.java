 ...
 * 
 */
public plan StrongEyeContactDeterminationPlan extends Plan {

    #handles event Level2PosAffectEvent ev6;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level2PosAffectEvent ev6)
    {
        return ev6.iAffect == AffectEnum.DETERMINATION;
    }
