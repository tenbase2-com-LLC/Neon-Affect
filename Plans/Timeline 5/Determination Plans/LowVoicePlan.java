...
public class LowVoicePlan extends aos.jack.jak.plan.Plan {
    ...
    private LowVoicePlan(aos.jack.jak.task.Task __t, NeonAffect.LowVoicePlan __env)
    {
    ...
    {
        return new NeonAffect.LowVoicePlan.__bodyFSM();
    }
    
    private LowVoicePlan(NeonAffect.Level2PosAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.LowVoicePlan __env)
    {
        this(__t,__env);
        this.ev6 = __ev;
    }
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new NeonAffect.LowVoicePlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__1640_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-LowVoicePlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.LowVoicePlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("LowVoicePlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__1640_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 4;
                            __state = 13;
                            __local__1640_0.printStackTrace();
                            break;
                        }
                        //* (49)             mutex.signal();    
                        case 13: 
        ...
        {
            return NeonAffect.LowVoicePlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.LowVoicePlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__1640_0);
                }
                default: 
                {
