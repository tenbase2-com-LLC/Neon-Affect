 ...
 * 
 */
public plan PositiveAffirmationSelfSatisifiedPlan extends Plan {

    #handles event Level1PosAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level1PosAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.SELF_SATISFIED;
    }
