 ...
 * 
 */
public plan AskingQuestionsArousedPlan extends Plan {

    #handles event Level2PosAffectEvent ev13;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level2PosAffectEvent ev13)
    {
        return ev13.iAffect == AffectEnum.AROUSED;
    }
