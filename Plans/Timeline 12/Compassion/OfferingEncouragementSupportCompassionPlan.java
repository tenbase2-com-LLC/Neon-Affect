 ...
 * 
 */
public plan OfferingEncouragementSupportCompassionPlan extends Plan {

    #handles event Level5PosAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level5PosAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.COMPASSION;
    }
