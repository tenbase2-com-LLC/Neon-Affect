...
public class LongPauseBeforeRespondingMacabrePlan extends aos.jack.jak.plan.Plan {
    ...
    public NeonAffect.Level4NegAffectEvent ev2;
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/LongPauseBeforeRespondingMacabrePlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    private final static java.lang.String[] __fsmLocalNames_body = {
            "__local__1581_0"};
    static boolean relevant(NeonAffect.Level4NegAffectEvent ev2)
    {
        return ev2.iAffect == NeonAffect.AffectEnum.MACABRE;
    }
    ...
    public LongPauseBeforeRespondingMacabrePlan()
    {
    }
    
    private LongPauseBeforeRespondingMacabrePlan(aos.jack.jak.task.Task __t, NeonAffect.LongPauseBeforeRespondingMacabrePlan __env)
    {
    ...
    {
        ev2 = (NeonAffect.Level4NegAffectEvent) __a.findEvent("NeonAffect.Level4NegAffectEvent");
        if (ev2 == null) {
            warning("Level4NegAffectEvent ev2: is not found in the capability/agent this plan comes from");
            return false;
        }
    ...
    {
        return new NeonAffect.LongPauseBeforeRespondingMacabrePlan.__bodyFSM();
    }
    
    private LongPauseBeforeRespondingMacabrePlan(NeonAffect.Level4NegAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.LongPauseBeforeRespondingMacabrePlan __env)
    {
        this(__t,__env);
        this.ev2 = __ev;
    }
    ...
    {
        return "NeonAffect.Level4NegAffectEvent";
    }
    
    public boolean __relevant(aos.jack.jak.event.Event __e)
    {
        return __ns.isEnabled() && relevant(((NeonAffect.Level4NegAffectEvent) __e));
    }
    
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        if (!(__e instanceof NeonAffect.Level4NegAffectEvent)) 
            return null;
        NeonAffect.Level4NegAffectEvent __e1 = (NeonAffect.Level4NegAffectEvent) __e;
        return new NeonAffect.LongPauseBeforeRespondingMacabrePlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__1581_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-LongPauseBeforeRespondingMacabrePlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.LongPauseBeforeRespondingMacabrePlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("LongPauseBeforeRespondingMacabrePlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__1581_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 4;
                            __state = 13;
                            __local__1581_0.printStackTrace();
                            break;
                        }
                        //* (49)             mutex.signal();
                        case 13: 
        ...
        {
            return NeonAffect.LongPauseBeforeRespondingMacabrePlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.LongPauseBeforeRespondingMacabrePlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__1581_0);
                }
                default: 
                {
