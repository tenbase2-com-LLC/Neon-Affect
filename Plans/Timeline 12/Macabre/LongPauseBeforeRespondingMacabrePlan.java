 ...
 * 
 */
public plan LongPauseBeforeRespondingMacabrePlan extends Plan {

    #handles event Level4NegAffectEvent ev2;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level4NegAffectEvent ev2)
    {
        return ev2.iAffect == AffectEnum.MACABRE;
    }
