 ...
 * 
 */
public plan ExpressingAttractionSexuallyExcitedPlan extends Plan {

    #handles event Level5NegAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level5NegAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.SEXUALLY_EXCITED;
    }
