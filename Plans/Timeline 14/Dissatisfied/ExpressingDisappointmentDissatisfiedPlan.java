...
public class ExpressingDisappointmentDissatisfiedPlan extends aos.jack.jak.plan.Plan {
    ...
    public NeonAffect.Level1NegAffectEvent ev1;
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/ExpressingDisappointmentDissatisfiedPlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    private final static java.lang.String[] __fsmLocalNames_body = {
            "__local__873_0"};
    static boolean relevant(NeonAffect.Level1NegAffectEvent ev1)
    {
        return ev1.iAffect == NeonAffect.AffectEnum.DISSATISFIED;
    }
    ...
    public ExpressingDisappointmentDissatisfiedPlan()
    {
    }
    
    private ExpressingDisappointmentDissatisfiedPlan(aos.jack.jak.task.Task __t, NeonAffect.ExpressingDisappointmentDissatisfiedPlan __env)
    {
    ...
    {
        ev1 = (NeonAffect.Level1NegAffectEvent) __a.findEvent("NeonAffect.Level1NegAffectEvent");
        if (ev1 == null) {
            warning("Level1NegAffectEvent ev1: is not found in the capability/agent this plan comes from");
            return false;
        }
    ...
    {
        return new NeonAffect.ExpressingDisappointmentDissatisfiedPlan.__bodyFSM();
    }
    
    private ExpressingDisappointmentDissatisfiedPlan(NeonAffect.Level1NegAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.ExpressingDisappointmentDissatisfiedPlan __env)
    {
        this(__t,__env);
        this.ev1 = __ev;
    }
    ...
    {
        return "NeonAffect.Level1NegAffectEvent";
    }
    
    public boolean __relevant(aos.jack.jak.event.Event __e)
    {
        return __ns.isEnabled() && relevant(((NeonAffect.Level1NegAffectEvent) __e));
    }
    
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        if (!(__e instanceof NeonAffect.Level1NegAffectEvent)) 
            return null;
        NeonAffect.Level1NegAffectEvent __e1 = (NeonAffect.Level1NegAffectEvent) __e;
        return new NeonAffect.ExpressingDisappointmentDissatisfiedPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__873_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-ExpressingDisappointmentDissatisfiedPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.ExpressingDisappointmentDissatisfiedPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("ExpressingDisappointmentDissatisfiedPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__873_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 4;
                            __state = 13;
                            __local__873_0.printStackTrace();
                            break;
                        }
                        //* (49)             mutex.signal();
                        case 13: 
        ...
        {
            return NeonAffect.ExpressingDisappointmentDissatisfiedPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.ExpressingDisappointmentDissatisfiedPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__873_0);
                }
                default: 
                {
