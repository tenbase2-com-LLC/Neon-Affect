 ...
 * 
 */
public plan ExpressingDisappointmentDissatisfiedPlan extends Plan {

    #handles event Level1NegAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level1NegAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.DISSATISFIED;
    }
