 ...
 * 
 */
public plan InvadingPersonalSpaceDomineeringPlan extends Plan {

    #handles event Level6NegAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level6NegAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.DOMINEERING;
    }
