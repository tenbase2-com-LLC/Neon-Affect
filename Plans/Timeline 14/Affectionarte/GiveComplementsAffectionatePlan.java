 ...
 * 
 */
public plan GiveComplementsAffectionatePlan extends Plan {

    #handles event Level4PosAffectEvent ev1;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level4PosAffectEvent ev1)
    {
        return ev1.iAffect == AffectEnum.AFFECTIONATE;
    }
