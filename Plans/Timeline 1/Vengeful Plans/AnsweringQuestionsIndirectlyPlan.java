...
public class AnsweringQuestionsIndirectlyPlan extends aos.jack.jak.plan.Plan {
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/AnsweringQuestionsIndirectlyPlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    {
        return ev13.iAffect == NeonAffect.AffectEnum.VENGEFUL;
    }
    ...
    public AnsweringQuestionsIndirectlyPlan()
    {
    }
    
    private AnsweringQuestionsIndirectlyPlan(aos.jack.jak.task.Task __t, NeonAffect.AnsweringQuestionsIndirectlyPlan __env)
    {
    ...
    {
        return new NeonAffect.AnsweringQuestionsIndirectlyPlan.__bodyFSM();
    }
    
    private AnsweringQuestionsIndirectlyPlan(NeonAffect.Level5NegAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.AnsweringQuestionsIndirectlyPlan __env)
    {
        this(__t,__env);
        this.ev13 = __ev;
    }
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new NeonAffect.AnsweringQuestionsIndirectlyPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__57_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-AnsweringQuestionsIndirectlyPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.AnsweringQuestionsIndirectlyPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("AnsweringQuestionsIndirectlyPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__57_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
        ...
        {
            return NeonAffect.AnsweringQuestionsIndirectlyPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.AnsweringQuestionsIndirectlyPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__57_0);
                }
                default: 
                {
