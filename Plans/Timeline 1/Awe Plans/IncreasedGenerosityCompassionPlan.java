...
public class IncreasedGenerosityCompassionPlan extends aos.jack.jak.plan.Plan {
    ...
    private static java.lang.String[] __tt__body = {
            "NeonAffect/IncreasedGenerosityCompassionPlan.plan",
            "body",
            "41",
            "43",
            "45",
    ...
    private final static java.lang.String[] __fsmLocalNames_body = {
            "__local__1370_0"};
    static boolean relevant(NeonAffect.Level6PosAffectEvent ev5)
    {
        return ev5.iAffect == NeonAffect.AffectEnum.AWE;
    }
    ...
    public IncreasedGenerosityCompassionPlan()
    {
    }
    
    private IncreasedGenerosityCompassionPlan(aos.jack.jak.task.Task __t, NeonAffect.IncreasedGenerosityCompassionPlan __env)
    {
    ...
    {
        return new NeonAffect.IncreasedGenerosityCompassionPlan.__bodyFSM();
    }
    
    private IncreasedGenerosityCompassionPlan(NeonAffect.Level6PosAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.IncreasedGenerosityCompassionPlan __env)
    {
        this(__t,__env);
        this.ev5 = __ev;
    }
    ...
    {
        return ev5.getSignature(__log);
    }
    
    public java.lang.String handledEvent()
    {
        return "NeonAffect.Level6PosAffectEvent";
    }
    
    public boolean __relevant(aos.jack.jak.event.Event __e)
    {
        return __ns.isEnabled() && relevant(((NeonAffect.Level6PosAffectEvent) __e));
    }
    
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        if (!(__e instanceof NeonAffect.Level6PosAffectEvent)) 
            return null;
        NeonAffect.Level6PosAffectEvent __e1 = (NeonAffect.Level6PosAffectEvent) __e;
        return new NeonAffect.IncreasedGenerosityCompassionPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__1370_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-IncreasedGenerosityCompassionPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.IncreasedGenerosityCompassionPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("IncreasedGenerosityCompassionPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        ...
                        case 11: 
                        {
                            __breakLevel = 2;
                            __state = 12;
                            __local__1370_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __breakLevel = 4;
                            __state = 13;
                            __local__1370_0.printStackTrace();
                            break;
                        }
                        //* (49)             mutex.signal();
                        case 13: 
        ...
        {
            return NeonAffect.IncreasedGenerosityCompassionPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.IncreasedGenerosityCompassionPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__1370_0);
                }
                default: 
                {
