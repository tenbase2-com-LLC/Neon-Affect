...
public class ScreamPlan extends aos.jack.jak.plan.Plan {
    ...
    private ScreamPlan(aos.jack.jak.task.Task __t, NeonAffect.ScreamPlan __env)
    {
    ...
    {
        return new NeonAffect.ScreamPlan.__bodyFSM();
    }
    
    private ScreamPlan(NeonAffect.Level6NegAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.ScreamPlan __env)
    {
        this(__t,__env);
        this.ev14 = __ev;
    }
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new NeonAffect.ScreamPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__2368_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-ScreamPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.ScreamPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("ScreamPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        //* (41)             System.out.println("Inside Scream plan.");
                        case 10: 
                        {
                            __breakLevel = 2;
                            __state = 11;
                            java.lang.System.out.println("Inside Scream plan.");
                            break;
                        }
                        //* (43)             behaviorName.add(0, getPlanName());
                        case 11: 
                        {
                            __state = 14;
                        ...
                        //* (45)         catch (BeliefSetException e)
                        case 12: 
                        {
                            __breakLevel = 2;
                            __state = 13;
                            __local__2368_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 13: 
                        {
                            __breakLevel = 4;
                            __state = 14;
                            __local__2368_0.printStackTrace();
                            break;
                        }
                        //* (51)             mutex.signal();
                        case 14: 
        ...
        {
            return NeonAffect.ScreamPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.ScreamPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__2368_0);
                }
                default: 
                {
