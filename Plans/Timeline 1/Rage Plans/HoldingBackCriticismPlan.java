...
public class HoldingBackCriticismPlan extends aos.jack.jak.plan.Plan {
    ...
    private static aos.jack.jak.plan.ExMap[] __exMap_body = {
            new aos.jack.jak.plan.ExMap(10,11,12,__exClass_0),
            new aos.jack.jak.plan.ExMap(10,13,14,null)};
    private static java.lang.String[] __tt__body = {
            "NeonAffect/HoldingBackCriticismPlan.plan",
            "body",
            "41",
            "42",
            "44",
    ...
    private final static java.lang.String[] __fsmLocalNames_body = {
            "__local__1277_0"};
    static boolean relevant(NeonAffect.Level6NegAffectEvent ev14)
    {
        return ev14.iAffect == NeonAffect.AffectEnum.RAGE;
    }
    ...
    public HoldingBackCriticismPlan()
    {
    }
    
    private HoldingBackCriticismPlan(aos.jack.jak.task.Task __t, NeonAffect.HoldingBackCriticismPlan __env)
    {
    ...
    {
        return new NeonAffect.HoldingBackCriticismPlan.__bodyFSM();
    }
    
    private HoldingBackCriticismPlan(NeonAffect.Level6NegAffectEvent __ev, aos.jack.jak.task.Task __t, NeonAffect.HoldingBackCriticismPlan __env)
    {
        this(__t,__env);
        this.ev14 = __ev;
    }
    ...
    {
        return ev14.getSignature(__log);
    }
    
    public java.lang.String handledEvent()
    {
        return "NeonAffect.Level6NegAffectEvent";
    }
    
    public boolean __relevant(aos.jack.jak.event.Event __e)
    {
        return __ns.isEnabled() && relevant(((NeonAffect.Level6NegAffectEvent) __e));
    }
    
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        if (!(__e instanceof NeonAffect.Level6NegAffectEvent)) 
            return null;
        NeonAffect.Level6NegAffectEvent __e1 = (NeonAffect.Level6NegAffectEvent) __e;
        return new NeonAffect.HoldingBackCriticismPlan(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.beliefset.BeliefSetException __local__1277_0;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-HoldingBackCriticismPlan.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(NeonAffect.HoldingBackCriticismPlan.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("HoldingBackCriticismPlan.body: Illegal state");
                            return FAILED_STATE;
                        }
                        //* (41)             System.out.println("Inside HoldingBackCriticismPlan.");
                        case 10: 
                        {
                            __breakLevel = 2;
                            __state = 11;
                            java.lang.System.out.println("Inside HoldingBackCriticismPlan.");
                            break;
                        }
                        //* (42)             behaviorName.add(0, getPlanName());
                        case 11: 
                        {
                            __state = 14;
                        ...
                        //* (44)         catch (BeliefSetException e)
                        case 12: 
                        {
                            __breakLevel = 2;
                            __state = 13;
                            __local__1277_0 = (aos.jack.jak.beliefset.BeliefSetException) __current;
                            break;
                        }
                        ...
                        case 13: 
                        {
                            __breakLevel = 4;
                            __state = 14;
                            __local__1277_0.printStackTrace();
                            break;
                        }
                        //* (50)             mutex.signal();
                        case 14: 
        ...
        {
            return NeonAffect.HoldingBackCriticismPlan.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("NeonAffect.HoldingBackCriticismPlan.body");
        }
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                case 0: 
                {
                    return aos.util.ToObject.box(__local__1277_0);
                }
                default: 
                {
