 ...
 * 
 */
public plan HighlyTalkativeAndExpressivePlan extends Plan {

    #handles event Level4PosAffectEvent ev3;
    #uses data PlanContextName planContextName;
    #uses data Behavior behaviorName;
    #uses data Semaphore mutex;
    
    static boolean relevant(Level4PosAffectEvent ev3)
    {
        return ev3.iAffect == AffectEnum.ELATION;
    }
