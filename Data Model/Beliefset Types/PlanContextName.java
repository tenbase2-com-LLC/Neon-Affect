...
public class PlanContextName extends aos.jack.jak.beliefset.OpenWorld {
    static public NeonAffect.PlanContextName__Tuple __hole = new NeonAffect.PlanContextName__Tuple(true);
    public NeonAffect.PlanContextName__Tuple[][] __tables;
    ...
    public aos.jack.jak.beliefset.BeliefSetCursor get(int __v0, aos.jack.jak.logic.StringVariable __v1)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        NeonAffect.PlanContextName__Tuple __t = new NeonAffect.PlanContextName__Tuple();
        NeonAffect.PlanContextName.__Cursor __c = new NeonAffect.PlanContextName.__Cursor(__t);
        __t.id = __v0;
        if (!__v1.check_unifiable(StringType)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("PlanContextName:get:IO: arg 1 strName Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.strName = __v1.as_string();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("PlanContextName:get:IO: got " + e.toString());
            }
        }
         else 
            __c.strName = __v1;
    ...
    {
        return new NeonAffect.PlanContextName__Tuple();
    }
    ...
    {
        return new NeonAffect.PlanContextName__Tuple[t];
    }
    ...
    {
        __tables = (NeonAffect.PlanContextName__Tuple[][]) t;
    }
    
    public aos.jack.jak.beliefset.BeliefSetCursor newCursor(aos.jack.jak.beliefset.Tuple __t)
    {
        if (__t instanceof NeonAffect.PlanContextName__Tuple) 
            return new NeonAffect.PlanContextName.__Cursor((NeonAffect.PlanContextName__Tuple) __t);
        return null;
    }
    ...
    public PlanContextName()
    {
    }
    
    public PlanContextName(java.lang.String n)
    {
        super();
        read(n);
    }
    ...
    class __Cursor extends aos.jack.jak.beliefset.OpenWorldCursor {
        public NeonAffect.PlanContextName__Tuple __tuple = null;
        public aos.jack.jak.logic.Variable id;
        public aos.jack.jak.logic.Variable strName;
        public __Cursor()
        {
            __tuple = __hole;
        }
        
        public __Cursor(NeonAffect.PlanContextName__Tuple __t)
        {
            super();
            __tuple = __t;
        }
        ...
        {
            NeonAffect.PlanContextName__Tuple[] __tab = __tables[__ti];
            NeonAffect.PlanContextName__Tuple __t;
            int __sz = __tab.length;
            int __i;
            if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_DB) != 0) {
                aos.jack.jak.core.Jak.log.log("PlanContextName__Tuple:match:" + __ti + ":" + __st + ":" + __c + ":" + __k + ":" + __ind);
                aos.jack.jak.core.Jak.log.log("Tuple=" + __tuple);
                aos.jack.jak.core.Jak.log.log("Outputs are");
                aos.jack.jak.core.Jak.log.log("  id:" + id);
                aos.jack.jak.core.Jak.log.log("  strName:" + strName);
            }
            for (__i = __st; __c > 0; __i = (__i + 1) % __sz, __c-- ) {
                ...
                try {
                    ...
                    if (__k) 
                        return __i;
                    if (strName == null) {
                        if (!__tuple.strName.equals(__t.strName)) 
                            continue;
                    }
                     else {
                        if (!strName.unify(__t.strName)) 
                            continue;
                    }
                }
                catch (java.lang.Exception e) {
        ...
        public aos.jack.jak.logic.ChoicePoint getChoicePoint()
        {
            ...
            if (strName != null) 
                return strName.getEnv().newChoicePoint();
            return null;
        }
