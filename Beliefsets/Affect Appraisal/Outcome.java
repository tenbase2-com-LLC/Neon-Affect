...
public class Outcome extends aos.jack.jak.beliefset.OpenWorld {
    static public NeonAffect.Outcome__Tuple __hole = new NeonAffect.Outcome__Tuple(true);
    public NeonAffect.Outcome__Tuple[][] __tables;
    ...
    {
        NeonAffect.Outcome__Tuple __t = new NeonAffect.Outcome__Tuple();
        NeonAffect.Outcome.__Cursor __c = new NeonAffect.Outcome.__Cursor(__t);
        __t.id = __v0;
        if (!__v1.check_unifiable(java.lang.Double.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("Outcome:get:IO: arg 1 dValue Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.dValue = __v1.as_double();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("Outcome:get:IO: got " + e.toString());
            }
        }
         else 
            __c.dValue = __v1;
    ...
    {
        return new NeonAffect.Outcome__Tuple();
    }
    ...
    {
        return new NeonAffect.Outcome__Tuple[t];
    }
    ...
    {
        __tables = (NeonAffect.Outcome__Tuple[][]) t;
    }
    
    public aos.jack.jak.beliefset.BeliefSetCursor newCursor(aos.jack.jak.beliefset.Tuple __t)
    {
        if (__t instanceof NeonAffect.Outcome__Tuple) 
            return new NeonAffect.Outcome.__Cursor((NeonAffect.Outcome__Tuple) __t);
        return null;
    }
    ...
    public Outcome(java.lang.String n)
    {
        super();
        read(n);
    }
    ...
    class __Cursor extends aos.jack.jak.beliefset.OpenWorldCursor {
        public NeonAffect.Outcome__Tuple __tuple = null;
        ...
        public __Cursor(NeonAffect.Outcome__Tuple __t)
        {
            super();
            __tuple = __t;
        }
        ...
        {
            NeonAffect.Outcome__Tuple[] __tab = __tables[__ti];
            NeonAffect.Outcome__Tuple __t;
            int __sz = __tab.length;
            int __i;
            if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_DB) != 0) {
                aos.jack.jak.core.Jak.log.log("Outcome__Tuple:match:" + __ti + ":" + __st + ":" + __c + ":" + __k + ":" + __ind);
