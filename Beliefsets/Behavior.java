...
public class Behavior extends aos.jack.jak.beliefset.OpenWorld {
    static public NeonAffect.Behavior__Tuple __hole = new NeonAffect.Behavior__Tuple(true);
    public NeonAffect.Behavior__Tuple[][] __tables;
    ...
    {
        NeonAffect.Behavior__Tuple __t = new NeonAffect.Behavior__Tuple();
        NeonAffect.Behavior.__Cursor __c = new NeonAffect.Behavior.__Cursor(__t);
        __t.id = __v0;
        if (!__v1.check_unifiable(StringType)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("Behavior:get:IO: arg 1 strName Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.strName = __v1.as_string();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("Behavior:get:IO: got " + e.toString());
            }
        }
         else 
            __c.strName = __v1;
    ...
    {
        return new NeonAffect.Behavior__Tuple();
    }
    ...
    {
        return new NeonAffect.Behavior__Tuple[t];
    }
    ...
    {
        __tables = (NeonAffect.Behavior__Tuple[][]) t;
    }
    
    public aos.jack.jak.beliefset.BeliefSetCursor newCursor(aos.jack.jak.beliefset.Tuple __t)
    {
        if (__t instanceof NeonAffect.Behavior__Tuple) 
            return new NeonAffect.Behavior.__Cursor((NeonAffect.Behavior__Tuple) __t);
        return null;
    }
    ...
    public Behavior(java.lang.String n)
    {
        super();
        read(n);
    }
    ...
    class __Cursor extends aos.jack.jak.beliefset.OpenWorldCursor {
        public NeonAffect.Behavior__Tuple __tuple = null;
        ...
        public __Cursor(NeonAffect.Behavior__Tuple __t)
        {
            super();
            __tuple = __t;
        }
        ...
        {
            NeonAffect.Behavior__Tuple[] __tab = __tables[__ti];
            NeonAffect.Behavior__Tuple __t;
            int __sz = __tab.length;
            int __i;
            if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_DB) != 0) {
                aos.jack.jak.core.Jak.log.log("Behavior__Tuple:match:" + __ti + ":" + __st + ":" + __c + ":" + __k + ":" + __ind);
