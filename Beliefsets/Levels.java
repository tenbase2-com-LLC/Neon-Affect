...
public class Levels extends aos.jack.jak.beliefset.OpenWorld {
    static public NeonAffect.Levels__Tuple __hole = new NeonAffect.Levels__Tuple(true);
    public NeonAffect.Levels__Tuple[][] __tables;
    ...
    {
        NeonAffect.Levels__Tuple __t = new NeonAffect.Levels__Tuple();
        NeonAffect.Levels.__Cursor __c = new NeonAffect.Levels.__Cursor(__t);
        if (!__v0.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("Levels:get:OO: arg 0 id Incorrect Variable type");
        if (__v0.isGround()) {
            try {
                __t.id = __v0.as_int();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("Levels:get:OO: got " + e.toString());
            }
        }
         else 
            __c.id = __v0;
        if (!__v1.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("Levels:get:OO: arg 1 level Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.level = __v1.as_int();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("Levels:get:OO: got " + e.toString());
            }
        ...
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        ...
        __t.id = __v0;
        if (!__v1.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("Levels:get:IO: arg 1 level Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.level = __v1.as_int();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("Levels:get:IO: got " + e.toString());
            }
        }
         else 
            __c.level = __v1;
    ...
    {
        return new NeonAffect.Levels__Tuple();
    }
    ...
    {
        return new NeonAffect.Levels__Tuple[t];
    }
    ...
    {
        __tables = (NeonAffect.Levels__Tuple[][]) t;
    }
    
    public aos.jack.jak.beliefset.BeliefSetCursor newCursor(aos.jack.jak.beliefset.Tuple __t)
    {
        if (__t instanceof NeonAffect.Levels__Tuple) 
            return new NeonAffect.Levels.__Cursor((NeonAffect.Levels__Tuple) __t);
        return null;
    }
    ...
    public Levels(java.lang.String n)
    {
        super();
        read(n);
    }
    ...
    class __Cursor extends aos.jack.jak.beliefset.OpenWorldCursor {
        public NeonAffect.Levels__Tuple __tuple = null;
        public aos.jack.jak.logic.Variable id;
        public aos.jack.jak.logic.Variable level;
        public __Cursor()
        {
            __tuple = __hole;
        }
        
        public __Cursor(NeonAffect.Levels__Tuple __t)
        {
            super();
            __tuple = __t;
        }
            ...
            for (__i = __st; __c > 0; __i = (__i + 1) % __sz, __c-- ) {
                ...
                try {
                    ...
                    if (__k) 
                        return __i;
                    if (level == null) {
                        if (__tuple.level != __t.level) 
                            continue;
                    }
                     else {
                        if (!level.unify(__t.level)) 
                            continue;
                    }
                }
                catch (java.lang.Exception e) {
        ...
        public aos.jack.jak.logic.ChoicePoint getChoicePoint()
        {
            ...
            if (level != null) 
                return level.getEnv().newChoicePoint();
            return null;
        }
