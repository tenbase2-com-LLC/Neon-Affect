...
public class AffectType extends aos.jack.jak.beliefset.OpenWorld {
    private aos.jack.jak.logic.IntegerVariable $affect;
    static public NeonAffect.AffectType__Tuple __hole = new NeonAffect.AffectType__Tuple(true);
    public NeonAffect.AffectType__Tuple[][] __tables;
    AffectType()
    {
        try {
    ...
    {
        NeonAffect.AffectType__Tuple __t = new NeonAffect.AffectType__Tuple();
        NeonAffect.AffectType.__Cursor __c = new NeonAffect.AffectType.__Cursor(__t);
        __t.id = __v0;
        if (!__v1.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("AffectType:get:IO: arg 1 iAffect Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.iAffect = __v1.as_int();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("AffectType:get:IO: got " + e.toString());
            }
        }
         else 
            __c.iAffect = __v1;
    ...
    int GetAffect()
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        NeonAffect.AffectType.__complex_1 __c = new NeonAffect.AffectType.__complex_1();
        try {
            return __c.__complex_1_GetAffect();
        }
    ...
    {
        return new NeonAffect.AffectType__Tuple();
    }
    ...
    {
        return new NeonAffect.AffectType__Tuple[t];
    }
    ...
    {
        __tables = (NeonAffect.AffectType__Tuple[][]) t;
    }
    
    public aos.jack.jak.beliefset.BeliefSetCursor newCursor(aos.jack.jak.beliefset.Tuple __t)
    {
        if (__t instanceof NeonAffect.AffectType__Tuple) 
            return new NeonAffect.AffectType.__Cursor((NeonAffect.AffectType__Tuple) __t);
        return null;
    }
    ...
    class __Cursor extends aos.jack.jak.beliefset.OpenWorldCursor {
        public NeonAffect.AffectType__Tuple __tuple = null;
        ...
        public __Cursor(NeonAffect.AffectType__Tuple __t)
        {
            super();
            __tuple = __t;
        }
        ...
        {
            NeonAffect.AffectType__Tuple[] __tab = __tables[__ti];
            NeonAffect.AffectType__Tuple __t;
            int __sz = __tab.length;
            int __i;
            if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_DB) != 0) {
                aos.jack.jak.core.Jak.log.log("AffectType__Tuple:match:" + __ti + ":" + __st + ":" + __c + ":" + __k + ":" + __ind);
    ...
    class __complex_1 extends aos.jack.plugin.view.rt.CleanupCursor {
            ...
            throws java.lang.Exception
        {
            ...
            try {
                __local_3 = true;
                if (__local_3) {
                    java.lang.System.out.println("Inside AffectType.GetAffect()");
                }
                genCursor(0).next();
