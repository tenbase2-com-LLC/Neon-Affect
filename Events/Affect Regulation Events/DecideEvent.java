...
public class DecideEvent extends aos.jack.jak.event.MessageEvent implements aos.apib.Base, java.io.Serializable {
...
public NeonAffect.DecideEvent post()
{
    NeonAffect.DecideEvent tmp = new NeonAffect.DecideEvent();
    tmp.init(this);
...
private NeonAffect.DecideEvent post_body()
{
    return this;
}
...
{
    return "NeonAffect/DecideEvent.event [" + super.stateInfo() + "]";
}
  ...
  static class __SS extends aos.apib.StreamerSupport {
    ...
    public aos.apib.Base new_instance() {
      return new DecideEvent();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new DecideEvent[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      default:
        if (i >= 0 && i <= 0) break;
        in.error("Reader for DecideEvent: illegal field number:"+i);
        return false;
      }
      return true;
    }
    ...
    public boolean write(aos.apib.OutStream out, aos.apib.Base o) {
      ...
      while ((i = out.nextField(i, this)) >= 0) {
        ...
        default:
          if (i >= 0 && i <= 0) break;
          out.error("Writer for DecideEvent: illegal field number:"+i);
          return false;
        }
      }
      return true;
