...
public class ContextEvent extends aos.jack.jak.event.MessageEvent implements aos.apib.Base, java.io.Serializable {
...
public NeonAffect.ContextEvent post()
{
    NeonAffect.ContextEvent tmp = new NeonAffect.ContextEvent();
    tmp.init(this);
...
private NeonAffect.ContextEvent post_body()
{
    return this;
}
...
{
    return "NeonAffect/ContextEvent.event [" + super.stateInfo() + "]";
}
  ...
  static class __SS extends aos.apib.StreamerSupport {
    ...
    protected void setup() {
      ...
      __def = (ContextEvent)newInstance();
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      default:
        if (i >= 0 && i <= 0) break;
        in.error("Reader for ContextEvent: illegal field number:"+i);
        return false;
      }
      return true;
    }
    ...
    public boolean write(aos.apib.OutStream out, aos.apib.Base o) {
      ...
      while ((i = out.nextField(i, this)) >= 0) {
        ...
        default:
          if (i >= 0 && i <= 0) break;
          out.error("Writer for ContextEvent: illegal field number:"+i);
          return false;
        }
      }
      return true;
