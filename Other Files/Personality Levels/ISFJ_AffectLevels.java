...
public class ISFJ_AffectLevels
{
    ...
    public ISFJ_AffectLevels()
    {
        ...
        affectTimelineList.add(new AffectLevel(-1, -6, AffectEnum.BITTERNESS));
        affectTimelineList.add(new AffectLevel(-1, -6, AffectEnum.OVERWHELMED));
        affectTimelineList.add(new AffectLevel(-1, -6, AffectEnum.RESENTMENT));
        affectTimelineList.add(new AffectLevel(-1, -6, AffectEnum.POWERLESS));      // Si-Fe overwhelm
        affectTimelineList.add(new AffectLevel(-1, -6, AffectEnum.GRIEF));          // Si processing loss
        affectTimelineList.add(new AffectLevel(-1, -6, AffectEnum.TORMENTED));      // Si-Fe loop
        ...
        affectTimelineList.add(new AffectLevel(-1, -6, AffectEnum.RAGE));           // Fe suppression break
        ...
        affectTimelineList.add(new AffectLevel(-1, -5, AffectEnum.DEVASTATION));    // Fe-Si processing
        ...
        affectTimelineList.add(new AffectLevel(-1, -5, AffectEnum.CONTEMPT));       // Fe shadow
        ...
        affectTimelineList.add(new AffectLevel(-1, -5, AffectEnum.FEEBLE));         // Si weakness
        affectTimelineList.add(new AffectLevel(-1, -5, AffectEnum.DISTRESSED));     // Fe pressure
        affectTimelineList.add(new AffectLevel(-1, -5, AffectEnum.DISCOURAGED));    // Si setback
        affectTimelineList.add(new AffectLevel(-1, -5, AffectEnum.IMPATIENCE));     // Fe frustration
        ...
        affectTimelineList.add(new AffectLevel(-1, -4, AffectEnum.ARROGANT));
        affectTimelineList.add(new AffectLevel(-1, -4, AffectEnum.EGOTISTICAL));
        affectTimelineList.add(new AffectLevel(-1, -4, AffectEnum.TERROR));         // Ne catastrophizing
        affectTimelineList.add(new AffectLevel(-1, -4, AffectEnum.DESPAIR));        // Fe hopelessness
        ...
        affectTimelineList.add(new AffectLevel(-1, -4, AffectEnum.CONTROLLING));    // Fe shadow
        affectTimelineList.add(new AffectLevel(-1, -4, AffectEnum.HYSTERIA));       // Ne panic
        affectTimelineList.add(new AffectLevel(-1, -4, AffectEnum.FRUSTRATION));    // Ti block
        affectTimelineList.add(new AffectLevel(-1, -4, AffectEnum.PITY));           // Fe condescension
        ...
        affectTimelineList.add(new AffectLevel(-1, -4, AffectEnum.UPSET));          // Fe disturbance

        // Level -3 (Moderate Negative States)
        affectTimelineList.add(new AffectLevel(-1, -3, AffectEnum.FEAR));           // Ne worry
        affectTimelineList.add(new AffectLevel(-1, -3, AffectEnum.GUILT));          // Fe responsibility
        affectTimelineList.add(new AffectLevel(-1, -3, AffectEnum.DREAD));          // Ne anticipation
        affectTimelineList.add(new AffectLevel(-1, -3, AffectEnum.DISGUST));        // Fe rejection
        affectTimelineList.add(new AffectLevel(-1, -3, AffectEnum.FLUSTERED));      // Si disruption
        affectTimelineList.add(new AffectLevel(-1, -3, AffectEnum.EMBARRASSED));    // Fe shame
        affectTimelineList.add(new AffectLevel(-1, -3, AffectEnum.TENSE));          // Si-Fe stress
        ...
        affectTimelineList.add(new AffectLevel(-1, -3, AffectEnum.APPALLED));       // Fe violation
        ...
        affectTimelineList.add(new AffectLevel(-1, -2, AffectEnum.CONFUSION));      // Ti uncertainty
        affectTimelineList.add(new AffectLevel(-1, -2, AffectEnum.DOUBT));          // Si-Ne tension
        ...
        affectTimelineList.add(new AffectLevel(-1, -2, AffectEnum.VIGOROUS));       // Ti push
        ...
        affectTimelineList.add(new AffectLevel(-1, -1, AffectEnum.CONFLICTED));     // Ti tension
        ...
        affectTimelineList.add(new AffectLevel(-1, 1, AffectEnum.ACTIVATED));       // Si engagement
        ...
        affectTimelineList.add(new AffectLevel(-1, 1, AffectEnum.SELF_SATISFIED));  // Ti contentment
        affectTimelineList.add(new AffectLevel(-1, 1, AffectEnum.PEACEFULNESS));    // Si tranquility
        ...
        affectTimelineList.add(new AffectLevel(-1, 3, AffectEnum.EMPATHY));
        affectTimelineList.add(new AffectLevel(-1, 3, AffectEnum.PRIDE));           // Ti achievement
        affectTimelineList.add(new AffectLevel(-1, 3, AffectEnum.HAPPY));           // Fe contentment
        ...
        affectTimelineList.add(new AffectLevel(-1, 4, AffectEnum.CONFIDENCE));      // Ti assurance
        affectTimelineList.add(new AffectLevel(-1, 4, AffectEnum.DEVOTED));         // Si-Fe dedication
        affectTimelineList.add(new AffectLevel(-1, 4, AffectEnum.BOLD));            // Ti assertion
        ...
        affectTimelineList.add(new AffectLevel(-1, 5, AffectEnum.FEARLESSNESS));    // Ti confidence
        ...
        affectTimelineList.add(new AffectLevel(-1, 5, AffectEnum.FREE));            // Ne release
        affectTimelineList.add(new AffectLevel(-1, 5, AffectEnum.POWERFUL));        // Ti strength
        affectTimelineList.add(new AffectLevel(-1, 5, AffectEnum.FASCINATED));      // Ne wonder

        // Level 6 (Peak Positive States)
        affectTimelineList.add(new AffectLevel(-1, 6, AffectEnum.STRONG));          // Ti confidence
        affectTimelineList.add(new AffectLevel(-1, 6, AffectEnum.MIGHTY));          // Ti power
        affectTimelineList.add(new AffectLevel(-1, 6, AffectEnum.TRIUMPHANT));      // Fe-Ti victory
        ...
        affectTimelineList.add(new AffectLevel(-1, 6, AffectEnum.LOVE));            // Fe devotion
